package de.miraculixx.mcord.buttons.events

import de.miraculixx.mcord.buttons.Buttons
    ...
    override suspend fun trigger(it: ButtonInteractionEvent) {
        ...
        when {
            ...
            id.startsWith("conButtonDelete_") -> {
                ...
                hook.editOriginal(":warning: __**Server Löschen**__ :warning:\n" +
                        "```diff\n" +
            ...
            id.startsWith("conButtonDelConfirm_") -> {
                ...
                hook.editOriginal("\uD83D\uDDD1️ __**Server Gelöscht**__ \uD83D\uDDD1️\n" +
